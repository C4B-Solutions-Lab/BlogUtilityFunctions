/*!
 * BlogUtilities JavaScript library v1.0.1
...
(
 function (window) {
    ...
    function removeTemporaryContainerToServeContent_Internal() {
    ...
    function postActionResponse_Internal(data, status) {
        removeTemporaryContainerToServeContent_Internal();
        refreshContent_Internal();
    }
                                                ...
                                                )
    {
        ...
        // load blog content depending on wheter use backward compatibility (v18) or v19+
        if(_useBackwardCompatibility === true) {
            ...
            jsUtilities.fillChildContainersUnderGivenParentContainer_3(
                                                                        _abstractionOfData,
                                                                        _parentContainerCssClass,
                                                                        _dataDivContainerCssClassName, _dataDivLineDefinitionContainerCssClassName, _errorDivContainerCssClassName,
                                                                        isFirstLineHoldingTitle, isLastLineHoldingCreationDate,
    ...
    function runContentEditor_Internal(editorContainerUniqueID) {
        ...
        $(_editorContainerUniqueIdInternal).load(_abstractionOfData, null);
